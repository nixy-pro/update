...
date_list=$(date +"%Y-%m-%d" -d "$data_server")
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e " WELCOME TO NIXY TUNNELING SCRIPT ${YELLOW}(${NC}${green}Stable Edition${NC}${YELLOW})${NC}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/nixy-pro/update/master/"
...
wget -q https://raw.githubusercontent.com/nixy-pro/update/master/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
